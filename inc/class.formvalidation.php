<?php
class ValidateForm {
  public $ValidType=array('text','numeric','email','empty','null');
  public $ErrString="";
  public $retval=false;
  public $ErrtxtPrefix='<div class="errortxt">';
  public $ErrtxtSufix='</div>';
  public $ErrPrefix='<fieldset  class="errorhead">';
  public $ErrSufix='</fieldset>';

function IsEmail($value){
if(!$this->IsEmpty($value)){
 if (!preg_match("/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/", $value)) return false;else return true; 
